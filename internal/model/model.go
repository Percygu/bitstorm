...
type Prize struct {
	...
	PrizeBegin   int       `gorm:"column:prize_begin;type:int(11);default:0;comment:发奖计划周期的开始;NOT NULL" json:"prize_begin"`
	PrizeEnd     int       `gorm:"column:prize_end;type:int(11);default:0;comment:发奖计划周期的结束;NOT NULL" json:"prize_end"`
	SysStatus    uint      `gorm:"column:sys_status;type:smallint(5) unsigned;default:0;comment:状态，0 正常，1 删除;NOT NULL" json:"sys_status"`
	SysCreated   time.Time `gorm:"autoUpdateTime;column:sys_created;type:datetime;default:1000-01-01 00:00:00;comment:创建时间;NOT NULL" json:"sys_created"`
	SysUpdated   time.Time `gorm:"autoUpdateTime;column:sys_updated;type:datetime;default:1000-01-01 00:00:00;comment:修改时间;NOT NULL" json:"sys_updated"`
